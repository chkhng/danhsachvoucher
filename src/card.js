      ...
      {selectedVoucher && (
        ...
        >
          <div style={{ display: "flex" }}>
            ...
            <div style={{ flex: 1 }}>
              <div>
                <div className="company" style={{ fontWeight: "bold" }}>{selectedVoucher.business.businessName}</div>
                <h2>{selectedVoucher.title}</h2>
                <div style={{ marginBottom: "8px" }}>Sử dụng đến: {formatDate(selectedVoucher.expiredAt)}</div>
